...
```{r table-model, echo=F, message=F}
ft.models.comp %>%
  set_table_properties(layout = "autofit") %>%
  #autofit() %>%
  paginate(init = TRUE, hdr_ftr = TRUE) %>%
...
::: {custom-style="Image Caption"} 
Figure `r fig.GAM.num`: Fitted generalized additive models (Gaussian family and the identity link function) to estimated abundance and their approximate 95% CIs."
:::
...
:::{custom-style="Image Caption"} 
Figure `r fig.fixed.post.num`: Posterior distributions of the fixed-effects coefficients for the visibility code ($\beta_{V}$) and Beaufort sea state ($\beta_{B}$).
:::
...
block_caption("Posterior distributions of year-specific P parameters.", 
              style = "Image Caption", 
...
block_caption(paste0("Effects of $S_1$ on the shape of the Richards equation. In this example, $S_2$ =", S2, ", K = ", K, ", P = ", P, ", $N_{max}$ = ", max.N, "."), 
              style = "Image Caption", 
              autonum = run_autonum(seq_id = "fig", 
                                    pre_label = "Figure S", 
                                    bkm = "Figure-S1",
...
block_caption(paste0("Effects of $S_2$ on the shape of the Richards equation. In this example, $S_1$ = ", S1, ", K = ", K, ", P = ", P, ", $N_{max}$ = ", max.N, "."), 
              style = "Image Caption", 
              autonum = run_autonum(seq_id = "fig", 
                                    pre_label = "Figure S",
                                    bkm = "Figure-S2"))
...
block_caption(paste0("Effects of $K$ on the shape of the Richards equation. In this example, $S_1$ = ", S1, ", $S_2$ = ", S2, ", $P$ = ", P, ", $N_{max}$ = ", max.N, "."), 
              style = "Image Caption", 
              autonum = run_autonum(seq_id = "fig", 
                                    pre_label = "Figure S",
                                    bkm = "Figure-K"))
...
block_caption(paste0("Effects of $P$ on the shape of the Richards equation. In this example, $S_1$ = ", S1, ", $S_2$ = ", S2, ", K = ", K, ", $N_{max}$ = ", max.N, "."), 
              style = "Image Caption", 
              autonum = run_autonum(seq_id = "fig", 
                                    pre_label = "Figure S",
                                    bkm = "Figure-P"))
...
block_caption(paste0("Trace plots of parameters with high ", R_hat, " values"), 
              style = "Image Caption", 
              autonum = run_autonum(seq_id = "fig", 
                                    pre_label = "Figure S",
                                    bkm = "Figure-trace-1"))
...
block_caption("Good (< 0.7) and bad (>= 0.7) Pareto-k statistics for each data point. y-axis indicates the observed number of gray whales per watch period.", 
              style = "Image Caption", 
              autonum = run_autonum(seq_id = "fig", 
                                    pre_label = "Figure S",
                                    bkm = "Figure-pareto-k"))
...
block_caption("Changes in the $S_1$ parameter of the Richards equation over time. $S_1$ defines the wideness of the right side of the curve.",
              style = "Image Caption",
              autonum = run_autonum(seq_id = "fig",
                                    pre_label = "Figure S",
...
block_caption("Changes in the $S_2$ parameter of the Richards equation over time. $S_1$ defines the wideness of the left side of the curve.",
              style = "Image Caption",
              autonum = run_autonum(seq_id = "fig",
                                    pre_label = "Figure S",
...
block_caption("Posterior density distributions of observer random effects. Observers with less than 10 sightings were pooled as one observer. ",
              style = "Image Caption",
              autonum = run_autonum(seq_id = "fig",
                                    pre_label = "Figure S",
