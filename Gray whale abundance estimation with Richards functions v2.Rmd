...
run.date <- Sys.Date()   # change this accordingly
...
In order to compare the proposed method to the method of Durban et al., I analyzed the same simulated dataset using the analytical approach in Durban et al.  
