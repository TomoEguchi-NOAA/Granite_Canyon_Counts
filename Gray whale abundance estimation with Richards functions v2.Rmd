...
run.date <- "2023-05-26" #"2023-04-14" #Sys.Date() #"2022-11-08" #   
...
run.date.real <- Sys.Date() #"2023-01-06"   # Change it accordingly
# out.file.name <- paste0("RData/JAGS_pois_binom_9yr_v2_", 
#                         run.date.real, ".rds")

out.file.name <- paste0("RData/JAGS_pois_binom_v2_9yr_v2_", 
                        run.date.real, ".rds")
...
save.fig.fcn(p.mean.N.hats.JAGS,
             file.name = paste0("figures/mean_N_pois_bino_real_", 
                                dpi.set, "dpi.png"),
             dpi = dpi.set, replace = save.fig)
...
save.fig.fcn(p.N.hats,
             file.name = paste0("figures/N_hats_BUGS_JAGS_real_", 
                                dpi.set, "dpi.png"),
             dpi = dpi.set, replace = save.fig)
