...
all.N.hats.df <- data.frame(Season = Corrected.Est.df.JAGS$Season,
                            Mean.JAGS = Corrected.Est.df.JAGS$Mean,
                            Median.JAGS = Corrected.Est.df.JAGS$Median,
                            LCL.JAGS = Corrected.Est.df.JAGS$LCL,
                            UCL.JAGS = Corrected.Est.df.JAGS$UCL,
                            Mean.BUGS = Corrected.Est.df.BUGS$Mean,
                            Median.BUGS = Corrected.Est.df.BUGS$Median,
                            LCL.BUGS = Corrected.Est.df.BUGS$LCL,
                            UCL.BUGS = Corrected.Est.df.BUGS$UCL)
