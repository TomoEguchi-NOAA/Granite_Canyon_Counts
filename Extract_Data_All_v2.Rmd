...
out.dir <- "RData/V2.1_Nov2024/out_"
...
#all.years <- c(2010, 2011, 2015, 2016, 2020, 2022, 2023, 2024)
...
grace_min <- 5 #60       # this makes it minimum of shift_dur_min - grace_min
...
if (save.output){
  ...
  saveRDS(out.obj, file = paste0(out.dir,  
                                 YEAR, "_min", min_dur, 
                                 "_Tomo_v2.rds"))
