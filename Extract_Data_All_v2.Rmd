...
The station information needs to be added. The data files that I have don't have that info... this needs to be fixed in the future. This has been fixed. 2023-12-12.
...
YEAR <- 2024 #Enter the year of the data files
...
Data4Laake_1 %>%
  left_join(Effort4Laake_1 %>%
              select(key, pphr), by = "key") -> Data4Laake_1
...
saveRDS(out.obj, file = paste0("RData/V2.1_Feb2024/out_", YEAR, "_min", min_dur, "_Tomo_v2.rds"))
