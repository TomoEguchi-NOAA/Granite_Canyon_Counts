...
This notebook describes an attempt to use the state space approach (AR(1)) to model the true N in the N-mixture model of Granite Canyon counts. The  observed counts are binomial deviates with the "true" N and capture probabilities that are affected by covariates; Beaufort sea state, visibility, and observers.  
