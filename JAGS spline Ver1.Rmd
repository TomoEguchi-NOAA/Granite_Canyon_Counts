...
for (k in 1:length(seasons)){
  # tmp <- readRDS(paste0("RData/V2_Aug2022/out_",
  #                       strsplit(seasons[k], "/")[[1]][2],
  #                       "_Tomo_v2.rds"))
  tmp <- readRDS(paste0("RData/out_",
                        strsplit(seasons[k], "/")[[1]][2],
                        "_Tomo_v2.rds"))
  Final_Data[[k]] <- tmp$FinalData %>%
...
Failure to calculate log density 2022-08-29
