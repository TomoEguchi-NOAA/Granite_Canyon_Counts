...
! SOMEHOW V9 IS CHARACTER IN THIS ONE... IT HAS NOT HAPPENED BEFORE AND I DO NOT KNOW
WHAT IS GOING ON HERE. NEED TO LOOK INTO WHY THIS ONE IS DIFFERENT FROM THE OTHERS. 2022-03-09
  summarise(max.n = max(V9),
            last.n = last(V9),
            d.max.last = max(V9) - last(V9))
