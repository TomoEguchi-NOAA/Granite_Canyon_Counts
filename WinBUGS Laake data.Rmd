...
This notebook describes abundance estimation of gray whales using Durban's WinBUGS code and data from Laake et al. (1967-2006). Data were obtained from https://github.com/jlaake/ERAnalysis/tree/master/ERAnalysis  
...
Get data from Laake paper. These csv files were created from the dataframes in the ERAnalysis project. 
