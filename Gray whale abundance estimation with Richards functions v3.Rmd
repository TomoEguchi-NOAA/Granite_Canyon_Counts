...
The daily estimated mean between Durban's and new approaches was similar qualitatively (Figure \@ref(fig:Figure-daily-N-hats)), indicating the two approached used the data in a similar manner. 
...
all.estimates.Eguchi %>% 
  filter(start.year > 2005) %>%
  left_join(all.estimates.Durban %>% filter(start.year > 2005), by = start.year) -> tmp
...
Combined together, the new approach improved the method of Durban et al. 
