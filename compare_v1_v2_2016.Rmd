...
First one has one more period in Josh's than mine.
...
The second one has one less whale in V1 than in V2.
...
out.shift <- get.shift(YEAR, data, ff=3, i=6)
...
data %>% filter(begin > tmp.V1[6,"begin"] & begin < tmp.V1[6, "end"]) -> data.3.6
...
```{r}
GET.SHIFT FUNCTION IS NOT WORKING FOR THIS DAY... PROBABLY BECAUSE THERE WAS A B-E PAIR WITH NO SIGHTINGS... NEED TO LOOK INTO THIS PROBLEM 2022-03-14
