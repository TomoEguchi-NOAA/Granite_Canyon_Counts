...
The third one has one more period in V1 than in V2 with 19 more whales in V1 than in V2
...
The fourth one has 2 more period in V1 than V2 with 8 more whales.
...
The fifth one has 1 more period in V2 than V1 with 14 more whales.
...
The sixth one has 1 more whale in V2 than V1.
...
The seventh one has 2 more whale in V2 than V1.
...
The eighth one has 1 more shift and 27 more whales in V1 than V2. Nothing returns from V2!
...
# Raw data file has the starting time of 13:40:05, which has been changed to
...
The ninth one has 1 more shift and 18 more whales in V1 than V2. 
...
Now V2 has one more whale than V1.
...
The following one has been fixed with modified data file.
...
The eleventh one has 1 more shift and 1 more whale in V1 than V2. 
...
# V2 is missing the shift starting at 73.5 (i = 4) with one whale sighting
