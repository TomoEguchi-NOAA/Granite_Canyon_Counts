...
This notebook includes the part that a GAM is fitted to the observed daily counts of gray whales. In this version (Ver4), I treat unobserved data points as "parameters" or missing values. 
