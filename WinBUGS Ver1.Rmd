...
# this does not do well because of differnet lengths:
begin <- cbind(begin, 
               out.V1.2020$FinalData$begin,
               out.V1.2022$FinalData$begin)
...
#watch end times
             ...
             out.V1.2020$FinalData$end,
             out.V1.2022$FinalData$end)

periods <- c(periods, 
             length(out.V1.2020$FinalData$begin),
             length(out.V1.2022$FinalData$begin))
# 
# #whale counts
