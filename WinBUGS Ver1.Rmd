...
# plus the new ones
periods <-c(136, 135, 164, 178, 179, 151, length(begin.2020), length(begin.2022))
...
jags.data <- list(n=data.0$n,
                  n.com=data.0$n,
                  n.sp=data.0$n,
                  n.station = dim(data.0$n)[2],
                  n.year = dim(data.0$n)[3],
                  n.obs = max(data.0$obs),
