...
# plus the new ones
periods <-c(136, 135, 164, 178, 179, 151, dim(data.0$n)[1], nrow(begin.2022))
...
Watch.Length.2022 <- end.2022[,2] - begin.2022[,2]
...
day <- cbind(data.0$day, 
             c(floor(begin.2022[,2]), 
               rep(NA, times = nrow(data.0$day) - nrow(begin.2022))))
