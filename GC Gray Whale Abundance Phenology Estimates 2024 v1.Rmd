...
Because the N-mixture modeling approach uses all data since 2006/2007 to estimate parameters that are shared among yearly datasets, annual estimates change as more data are added to the analysis. In the past, we only provided the new estimate and kept the estimates for previous years as they were provided in the reports. This year, we provide updated estimates as well as estimates in the previous reports.
...
flextable(all.estimates.2024 %>% na.omit() %>% dplyr::select(-Year)) %>% 
