...
flextable(whale.counts.v1.df) %>% 
  set_caption(paste0("Survey effort between the 2006/2007 and 2021/2022 seasons when Ver1.0 extraction code was used. Periods are the number of suvey periods (minimum of 85 and maximum of 95 minutes, and the total numbers of observed whales are in Counts."))  %>%
  set_table_properties(width = 0.5, layout = "autofit")
```
...
flextable(whale.counts.v2.df) %>% 
  set_caption(paste0("Survey effort between the 2006/2007 and 2021/2022 seasons when Ver2.0 extraction code was used. Periods are the number of suvey periods (minimum of 85 and maximum of 95 minutes, and the total numbers of observed whales are in Counts."))  %>%
  set_table_properties(width = 0.5, layout = "autofit")
```
