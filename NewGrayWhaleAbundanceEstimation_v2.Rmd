...
In their analysis, convergence of the WinBUGS analysis was not thoroughly determined. Since the study was published in 2015, new tools were developed to more comprehensively evaluate convergence of MCMC samples. The new tools (rank-normalized Rhat statistic and bulk and tail effective sample sizes; Vehtari et al. 2020?) indicated that Durban's model did not converge well for all parameters. 
...
out.table <- data.frame(model = model.ID,
  ...
  arrange(by = c(min.ESS.bulk, dLOOIC)) %>% 
...
The eight models (Table \@ref(tab:model-definition)) were fitted to the sightings data over 32 seasons. Three models (`r out.table %>% filter(n.big.Rhat == 0) %>% pull(model)`) indicated satisfactory convergence of MCMC (Table \@ref(tab:model-table)), whereas the rest did not. Among the three models, based on LOOIC, Model `r` was identified as the best-fitting model (Table \@ref(tab:model-table)). The model consists of year-specific $P$ ($P_1 = P_2$), $S_1$, and $S_2$ parameters (Table \@ref(tab:model-definition)).
