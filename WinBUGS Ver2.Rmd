...
# Analysis with minimum of 30 minutes sampling duration:
out.v2 <- lapply(years, FUN = function(x) readRDS(paste0("RData/V2.1_Mar2023/out_", x, "_min30_Tomo_v2.rds")))
...
out.file.name <- paste0("RData/WinBUGS_", x, "yr_v2_min30.rds")
