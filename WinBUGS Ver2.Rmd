...
MCMCparams <- list(n.iter = 1000, #00,
                   n.thin = 8, #0,
                   n.burnin = 600, #00,
                   n.chains = 3)
...
# data were resulting in error - "undefined real result" (ran with n.iter = 1000, n.thin = 8, n.burnin = 600, n.chains = 3)
...
# 
# saveRDS(file = "RData/BUGS_data_runs.rds", data.worked)
# rm(list = ls())
#
