...
WinBUGS.input <- data2WinBUGS_input(data.dir = "RData/V2.1_Nov2024",
                                    ...
                                    min.dur = 10) # one of 10, 30, 85 or any other that was used in Extract_Data_All_v2.Rmd

# Good to run with 10k/6k as a practice run to see if WinBUGS completes computation.
# Then, increase iterations/burnin to 100k/60k. Sometimes... 

# MCMCparams <- list(n.iter = 100000,# 85000, #200, #
#                    n.thin = 80, #50, #2, #80
#                    n.burnin = 60000, #50000, #50, #
#                    n.chains = 5)
# 
