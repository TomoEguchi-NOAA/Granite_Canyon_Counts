...
#obs.model <- "pois"
bos.model <- "bino"
#jags.model <- paste0("models/model_Richards_norm_bino.txt")
jags.model <- paste0("models/model_Richards_norm_", obs.model, ".txt")

out.file.name <- paste0("RData/JAGS_Richards_v1_", obs.model, 
                        "pois_2022-09-09.RData")
