...
#data.v2 <- readRDS("RData/WinBUGS_10yr_v2_min85.rds")
...
```{r}
if (ver != "v4"){
  mcmc_trace(jm.out$jm$samples, c("K[1]", "K[2]",
                           "K[3]", "K[4]",
                           "K[5]", "K[6]",
                           "K[7]", "K[8]", 
                           "K[9]", "K[10]"))
...
```{r}
mcmc_trace(jm.out$jm$samples, c("S1[1]", "S1[2]",
                         "S1[3]", "S1[4]",
                         "S1[5]", "S1[6]",
                         "S1[7]", "S1[8]", 
                         "S1[9]", "S1[10]"))
...
```{r}
mcmc_dens(jm.out$jm$samples, c("S1[1]", "S1[2]",
                         "S1[3]", "S1[4]",
                         "S1[5]", "S1[6]",
                         "S1[7]", "S1[8]", 
                        "S1[9]", "S1[10]"))
...
```{r}
mcmc_trace(jm.out$jm$samples, c("S2[1]", "S2[2]",
                         "S2[3]", "S2[4]",
                         "S2[5]", "S2[6]",
                         "S2[7]", "S2[8]", 
                         "S2[9]", "S2[10]"))
...
```{r}
mcmc_dens(jm.out$jm$samples, c("S2[1]", "S2[2]",
                         "S2[3]", "S2[4]",
                         "S2[5]", "S2[6]",
                         "S2[7]", "S2[8]", 
                        "S2[9]", "S2[10]"))
...
```{r}
mcmc_trace(jm.out$jm$samples, c("Max[1]", "Max[2]",
                          "Max[3]", "Max[4]",
                         "Max[5]", "Max[6]",
                          "Max[7]", "Max[8]", 
                         "Max[9]", "Max[10]"))
...
```{r}
mcmc_dens(jm.out$jm$samples, c("Max[1]", "Max[2]",
                          "Max[3]", "Max[4]",
                         "Max[5]", "Max[6]",
                          "Max[7]", "Max[8]", 
                        "Max[9]", "Max[10]"))
...
```{r}
# Check conversions
mcmc_trace(jm.out$jm$samples, 
           c("Corrected.Est[1]", "Corrected.Est[2]",
             "Corrected.Est[3]", "Corrected.Est[4]",
             "Corrected.Est[5]", "Corrected.Est[6]",
             "Corrected.Est[7]", "Corrected.Est[8]", 
             "Corrected.Est[9]", "Corrected.Est[10]"))

```


```{r}
mcmc_dens(jm.out$jm$samples, 
          c("Corrected.Est[1]", "Corrected.Est[2]",
            "Corrected.Est[3]", "Corrected.Est[4]",
            "Corrected.Est[5]", "Corrected.Est[6]",
            "Corrected.Est[7]", "Corrected.Est[8]", 
...
```{r}
WinBugs.summary <- data.v2$BUGS_out$summary %>% 
  as.data.frame() %>% 
