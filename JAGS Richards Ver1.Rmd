...
data.9yr.v2 <- readRDS("RData/WinBUGS_9yr_v2.rds")
data.WinBUGS <- data.9yr.v2$BUGS.data

out.file.name <- paste0("RData/JAGS_Richards_", 
                        models, "_", ver,
                        "_9yr_v2_", Sys.Date(), ".RData")
...
jags.data <- list(  n = data.WinBUGS$n,
                    n.station = c(1, 1, 2, 2, rep(1, times = 5)),
                    ...
                    vs = scale(data.WinBUGS$vs),
                    bf = scale(data.WinBUGS$bf),
...
LOOIC.n <- compute.LOOIC(loglik.array = jm$sims.list$log.lkhd,
...
mcmc_trace(jm$samples, c("Corrected.Est[1]", "Corrected.Est[2]",
                         ...
                         "Corrected.Est[7]", "Corrected.Est[8]", "Corrected.Est[9]"))
