...
jags.model <- paste0("models/model_Richards_imputation_dnorm.txt")
...
```{r}
mcmc_trace(jm$samples, c("S[1]", "S[2]",
                         "S[3]", "S[4]"))
...
```{r}
mcmc_dens(jm$samples, c("S[1]", "S[2]",
                         "S[3]", "S[4]"))
