...
# Doesn't seem to make any difference  2022-10-05
N_inits[which(N_inits == 0, arr.ind = T)] <- 1

BUGS.data.1 <- list(n = data.worked$BUGS.data$n[, 1, 7:8],
                    n.com = data.worked$BUGS.data$n.com[, 1, 7:8],
                    n.sp = data.worked$BUGS.data$n.sp[, 1, 7:8],
                    n.station = 1,
                    n.year = 2,
                    obs = data.worked$BUGS.data$obs[, 1, 7:8],
                    n.obs = n.obs,
                    periods = data.worked$BUGS.data$periods[7:8],
                    u = data.worked$BUGS.data$u[, 1, 7:8],
...
bm <- bugs(data = data.worked$BUGS.data, #BUGS.data.1,
