...
day <- jags.data$day
for(i in 1:length(jags.data$periods)){ #Set the anchor points: days 1 and 90
...
N <- matrix(NA, 
            ...
            ncol=length(jags.data$periods)) 

#True number of whales passing fixed at 0 for day 1 and 90
for(i in 1:length(jags.data$periods)){
...
BUGS.data <- list(n = jags.data$n,
                  ...
                  #begin=begin,
                  #end=end,
                  Watch.Length=Watch.Length)  # NEED TO FIX THIS 2022-09-28
