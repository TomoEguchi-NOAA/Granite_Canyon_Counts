...
In order to compare the new method to the current method (Durban et al.), I analyzed the same simulated dataset with the analytical approach in Durban et al. WinBUGS returns error (undefined real reslut), which appears to be caused by computing log(0). I can't find the problem. I'll move on to comparing results of real datasets. 
...
# n[is.na(n)] <- 0
# 
# # because all covariates were the same as the real data, I pull out the u
# # array directly from the input.
# u <- data.worked$BUGS.data$u[,,7:8]
# 
