...
set.seed(12345)
S1 <- runif(4, -5, -0.5) #c(0.8, 1.2, 1.4, 0.9)
S2 <- runif(4, 0.5, 5)   #c(1.5, 2.1, 1.2, 1.9)   # fatness
K <- runif(4, 0.1, 3)    #c(1.0, 1.2, 1.3, 1.2)   # peak flatness
P <- rdunif(4, 40, 50)   #c(40, 45, 50, 42)       # peak timing
max.N <- rdunif(4, 600, 1000)   #c(800, 850, 820, 600)
#CV <- 0.3
